...
$currentLevel = "B1"; // Seviyeyi B1 yaptık

// B1 SEVİYESİNE ÖZEL: DAHA DERİN VE KARMAŞIK KONULAR
$videoTests = [
    ["id" => 1, "img" => "https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&q=80&w=600", "tag" => "İş Dünyası", "link" => "kalan_seviyeler.php"],
    ["id" => 2, "img" => "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=600", "tag" => "Akademik Hayat", "link" => "kalan_seviyeler.php"],
    ["id" => 3, "img" => "https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?auto=format&fit=crop&q=80&w=600", "tag" => "Çevre & Doğa", "link" => "kalan_seviyeler.php"],
    ["id" => 4, "img" => "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&q=80&w=600", "tag" => "Teknoloji", "link" => "kalan_seviyeler.php"],
    ["id" => 5, "img" => "https://images.unsplash.com/photo-1527529482837-4698179dc6ce?auto=format&fit=crop&q=80&w=600", "tag" => "Kültür & Sanat", "link" => "kalan_seviyeler.php"],
    ["id" => 6, "img" => "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&q=80&w=600", "tag" => "Dijital Dünya", "link" => "kalan_seviyeler.php"],
    ["id" => 7, "img" => "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=600", "tag" => "Sunum Teknikleri", "link" => "kalan_seviyeler.php"],
    ["id" => 8, "img" => "https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&q=80&w=600", "tag" => "Grup Tartışması", "link" => "kalan_seviyeler.php"],
    ["id" => 9, "img" => "https://images.unsplash.com/photo-1491438590914-bc09fcaaf77a?auto=format&fit=crop&q=80&w=600", "tag" => "Toplumsal Olaylar", "link" => "kalan_seviyeler.php"],
    ["id" => 10, "img" => "https://images.unsplash.com/photo-1506784983877-45594efa4cbe?auto=format&fit=crop&q=80&w=600", "tag" => "Gelecek Planları", "link" => "kalan_seviyeler.php"],
];
?>
<!DOCTYPE html>
<html lang="tr">
<head>
    ...
    <title>FluentLift | B1 Video Paneli</title>
...
.nav-link:hover:not(.active) { 
    ...
    transform: translateX(5px);
        ...
        /* İSTEDİĞİN SİYAH YAZILI KATEGORİ ETİKETİ */
        .card-tag {
...
<main class="main-content">
    <div class="page-header">
        <span>INTERMEDIATE (B1) SEVİYESİ</span>
    ...
    <div class="test-grid">
        ...
        <div class="test-card">
            <img src="<?php echo $test['img']; ?>" alt="B1 Seviye Görseli">
