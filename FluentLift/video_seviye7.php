   ...
   <section class="content-layout">
    ...
    <div class="quiz-card">
        ...
        <p style="font-size: 0.95rem; margin-bottom: 20px; line-height: 1.6;">
           Şu an nerede oldugunu söylüyor?
        </p>
        ...
        <div id="hint-box">
            ...
            <p style="font-size: 0.85rem; color: #cbd5e1;">
                Videoda <b>Doctor's office </b> kelimesine dikkat et.
            </p>
        </div>
    </div>
</section>
...
<footer class="action-footer">
    <a href="video_seviye6.php" class="btn-nav">⬅️ Önceki</a>
    <a href="video_seviye8.php" class="btn-nav">Sonraki ➡️</a>
</footer>
