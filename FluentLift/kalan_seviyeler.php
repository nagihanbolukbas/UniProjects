...
$videoSource = "https://www.youtube.com/embed/oU1GTQlrWSM?start=8&autoplay=1&mute=0";
?>
<!DOCTYPE html>
<html lang="tr">
<head>
...
<a href="profil.php" class="btn-profile"><?php echo $userName; ?></a>        </div>
  ...
  <section class="content-layout">
    <div class="quiz-card" style="grid-column: 1 / -1; text-align: center; padding: 80px 40px;">
        ...
        <p style="
            ...
            line-height: 1.8;
        ">
            Seçtiğiniz seviye için yeni video içerikleri hazırlanıyor.
            Çok yakında konuşma pratiği yapabileceğiniz eğitici videolar burada olacak.
        </p>

        <a href="seviye_belirle.php" class="btn-profile" style="
...
<footer class="action-footer">
    <a href="seviye_belirle.php" class="btn-nav">⬅️ Seviye Seçimine Dön</a>
</footer>