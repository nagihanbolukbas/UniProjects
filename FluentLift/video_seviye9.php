...
$videoSource = "https://www.youtube.com/embed/CiKt3Hsfo-s?start=35&autoplay=1&mute=0";
$currentLevel = "A1"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
  ...
  <div class="quiz-card">
    ...
    <p style="font-size: 0.95rem; margin-bottom: 20px; line-height: 1.6;">
        Müzede hangi eserlerden bahsediliyor?
    </p>
    ...
    <div id="hint-box">
        ...
        <p style="font-size: 0.85rem; color: #cbd5e1;">
            Videoda <b>"These paintings are amazing."</b> ifadesine dikkat et.
        </p>
    </div>
</div>
</section>
...
<footer class="action-footer">
    <a href="video_seviye8.php" class="btn-nav">⬅️ Önceki</a>
    <a href="video_seviye10.php" class="btn-nav">Sonraki ➡️</a>
</footer>
