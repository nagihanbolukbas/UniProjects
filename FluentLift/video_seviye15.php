...
$videoSource = "https://www.youtube.com/embed/FdmFgL3pci0?start=42&rel=0&autoplay=1";
$currentLevel = "A2"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
    <div class="video-area">
        ...
        <!-- Kelime Kartları (Turkuaz Tasarım) -->
        <div class="vocab-section">
            <div class="vocab-card"><b>Recommend</b><span>Tavsiye Vermek</span></div>
            <div class="vocab-card"><b>Main Course</b><span>Ana Yemek</span></div>
            <div class="vocab-card"><b>Check/Bill</b><span>Hesap</span></div>
        </div>
    </div>

    <!-- Quiz Kartı -->
    <div class="quiz-card">
        <h3 style="color:var(--accent); margin-bottom:10px;">🎯 Sipariş Zamanı</h3>
        <p style="margin-bottom: 20px;">
           Garson müşteriye ne tavsiye ediyor?
        </p>
        ...
        <!-- İpucu / Bilgi Notu (Hata yapıldığında veya tıklandığında görünür) -->
        <div id="hint-box" style="display:none; margin-top: 20px; background: rgba(6, 182, 212, 0.05); padding: 20px; border-radius: 25px; border: 1px solid rgba(6, 182, 212, 0.2);">
            <h4 style="color: var(--accent); font-size: 0.9rem;">💡 Bilgi Notu</h4>
            <p style="font-size: 0.85rem; color: #cbd5e1;">
                Garson videoda "Are you ready to order?" diyerek söze başlıyor. İngilizce restoran diyaloglarında sipariş almak için en çok kullanılan kalıp budur.
            </p>
        </div>
    </div>
</section>
...
<div class="footer-wrapper">
    ...
    <footer class="action-footer">
        <a href="video_seviye14.php" class="btn-nav">⬅️ Önceki</a>
    </footer>

    <div class="video-status-box">
       Şu an için devam bölümü bulunmuyor.
    </div>
