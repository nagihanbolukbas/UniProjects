...
$videoSource = "https://www.youtube.com/embed/51_Yo7bzFcs?start=42&autoplay=1&mute=0";
$currentLevel = "A1"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
    ...
    <div class="quiz-card">
        ...
        <p style="font-size: 0.95rem; margin-bottom: 20px;">
            Konuşmacı sabahları genellikle ne yapıyor?
        </p>
        ...
        <div class="options-group">
            ...
            <button class="option-btn" onclick="handleChoice(this, false)">
                B) Alışverişe gidiyor
            </button>

            <button class="option-btn" onclick="handleChoice(this, false)">
                C) Televizyon izliyor
            </button>
        ...
        <div id="hint-box">
            ...
            <p style="font-size: 0.85rem; color: #cbd5e1;">
                Videoda "breakfast" (kahvaltı) ve "usually" (genellikle)
...
<footer class="action-footer">
    <a href="video_seviye.php" class="btn-nav">
        <span>⬅️</span> Önceki Video
    </a>
    <a href="video_seviye3.php" class="btn-nav">
