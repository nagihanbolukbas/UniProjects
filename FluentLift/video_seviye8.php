...
$videoSource = "https://www.youtube.com/embed/FGrWmUGtv4g?start=63&autoplay=1&mute=0";
$currentLevel = "A1"; 
?>
<!DOCTYPE html>
<html lang="tr">
    ...
    <div class="video-area">
        ...
        <div class="vocab-section">
            <div class="vocab-card">
                <b>Marketing Assistant</b>
                <span>Pazarlama Asistanı</span>
            </div>
            <div class="vocab-card">
                <b>Office</b>
                <span>Ofis</span>
    ...
    <div class="quiz-card">
        ...
        <div id="hint-box">
            ...
            <p style="font-size: 0.85rem; color: #cbd5e1;">
                Videoda <b>"I'm a marketing assistant"</b> ifadesine dikkat et.
            </p>
        </div>
    </div>
</section>
...
<footer class="action-footer">
    <a href="video_seviye7.php" class="btn-nav">⬅️ Önceki</a>
    <a href="video_seviye9.php" class="btn-nav">Sonraki ➡️</a>
</footer>
