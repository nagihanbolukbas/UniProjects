...
$videoSource = "https://www.youtube.com/embed/ImPx52f8myc?start=1044&autoplay=1&mute=0";
$currentLevel = "A2"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
        <div class="video-area">
            <div class="video-container">
                <iframe src="<?php echo $videoSource; ?>" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>

            <div class="vocab-section">
                <div class="vocab-card"><b>Upload</b><span>Yüklemek (Dosya vb.)</span></div>
                <div class="vocab-card"><b>Subfolder</b><span>Alt Klasör</span></div>
                <div class="vocab-card"><b>Template</b><span>Şablon / Taslak</span></div>
            </div>
        </div>

        <div class="quiz-card">
            <h3 style="color:var(--accent); margin-bottom:10px;">🎯 Eğitim Sorusu</h3>
            <p style="margin-bottom: 20px;">
                Sarah'nın eğitimine göre, şirket sürücüsüne (drive) hızlıca dosya yüklemek için hangi yöntem kullanılmalıdır?
            </p>

            <div class="options-group">
                <button class="option-btn" onclick="handleChoice(this, false)">A) Dosyaları e-posta ile göndererek.</button>
                <button class="option-btn" onclick="handleChoice(this, false)">B)Dosyaları manuel olarak tek tek yazarak. </button>
                <button class="option-btn" onclick="handleChoice(this, false)">C) Bilgisayarı yeniden başlatarak.</button>
                <button class="option-btn" onclick="handleChoice(this, true)">D) Dosyaları doğrudan sürükleyip bırakarak.</button>
            </div>

            <div id="hint-box">
                <h4 style="color: var(--accent); font-size: 0.9rem;">💡 Bilgi Notu</h4>
                <p style="font-size: 0.85rem; color: #cbd5e1;">
                    Sarah videoda "Just drag them in, very simple" (Sadece içeri sürükle, çok basit) diyerek en pratik yöntemi gösteriyor.
                </p>
            </div>
        </div>
    </section>
<footer class="action-footer">
    <a href="video_seviye13.php" class="btn-nav">⬅️ Önceki Video</a>
    <a href="video_seviye15.php" class="btn-nav"> Sonraki Video ➡️ </a>
</footer>
