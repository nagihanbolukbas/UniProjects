...
$videoSource = "https://www.youtube.com/embed/_2SD81Ko-7E?start=103&autoplay=1&mute=0";
$currentLevel = "A1"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
    ...
    <p style="font-size: 0.95rem; margin-bottom: 20px; line-height: 1.6;">
        Anna'nın takvimine göre saat 10:00'da hangi etkinlik var?
    </p>
    ...
    <div class="options-group">
        ...
        <button class="option-btn" onclick="handleChoice(this, false)">
            ...
            <p style="font-size: 0.85rem; color: #cbd5e1;">
               'Videoda <b>team meeting </b> ifadesine dikkat et.
            </p>
        </div>
</div>
</section>
...
<footer class="action-footer">
    <a href="video_seviye3.php" class="btn-nav">⬅️ Önceki</a>
    <a href="video_seviye5.php" class="btn-nav">Sonraki ➡️</a>
</footer>
