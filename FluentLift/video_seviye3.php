...
$videoSource = "https://www.youtube.com/embed/fJHCDMFJU2U?start=18&autoplay=1&mute=0";
$currentLevel = "A1"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
    ...
    <div class="quiz-card">
        ...
        <p style="font-size: 0.95rem; margin-bottom: 20px;">
            Konuşmacı nerede yaşadığını söylüyor?
        </p>
        ...
        <div class="options-group">
            ...
            <p style="font-size: 0.85rem; color: #cbd5e1;">
               'Videoda <b>live in United States </b> ifadesine dikkat et.
            </p>
        </div>
    </div>
    </div>
...
<footer class="action-footer">
    <a href="video_seviye2.php" class="btn-nav">
        <span>⬅️</span> Önceki Video
    </a>
    <a href="video_seviye4.php" class="btn-nav">
