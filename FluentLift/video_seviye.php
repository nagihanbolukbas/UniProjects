...
$videoSource = "https://www.youtube.com/embed/0U7DMOoEkEs?start=30&autoplay=1&mute=0";
$currentLevel = "A1"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<main class="main-content">
    <header>
        ...
        <div class="user-stats-wrapper">
            ...
            <a href="profil.php" class="btn-profile"><?php echo $userName; ?></a>
        </div>
    </header>
    ...
    <section class="content-layout">
        <div class="video-area">
            ...
            <div class="vocab-section">
                <div class="vocab-card"><b>Relax</b><span>Rahatlamak</span></div>
                <div class="vocab-card"><b>Prefer</b><span>Tercih Etmek</span></div>
                <div class="vocab-card"><b>Forget</b><span>Unutmak</span></div>
            </div>
        </div>

        <div class="quiz-card">
            <h3 style="color:var(--accent); margin-bottom:10px;">🎯 Soru</h3>
            <p style="font-size: 0.95rem; margin-bottom: 20px;">Konuşmacı neden kitap okumayı tercih ediyor?</p>
            
            <div class="options-group">
                <button class="option-btn" onclick="handleChoice(this, false)">A) Enerjik hissetmek için</button>
                <button class="option-btn" onclick="handleChoice(this, true)">B) Rahatlamak ve stresi unutmak için</button>
                <button class="option-btn" onclick="handleChoice(this, false)">C) Yeni şeyler öğrenmek için</button>
                <button class="option-btn" onclick="handleChoice(this, false)">D) Netflix'ten sıkıldığı için</button>
            </div>

            <div id="hint-box">
                <h4 style="color: #ff6b6b; margin-bottom: 5px; font-size: 0.9rem;">💡 İpucu</h4>
                <p style="font-size: 0.85rem; color: #cbd5e1;">Videoda "relax" (rahatlamak) ve "forget stress" (stresi unutmak) kelimelerine dikkat et!</p>
            </div>
        </div>
    </section>

    <footer class="action-footer">
        <a href="#" class="btn-nav"><span>⬅️</span> Önceki Video</a>
        <a href="video_seviye2.php" class="btn-nav">Sonraki Video <span>➡️</span></a>
    </footer>
</main>
