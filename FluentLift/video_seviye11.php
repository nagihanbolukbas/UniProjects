...
$videoSource = "https://www.youtube.com/embed/PNJGkemEu3E?start=15&autoplay=1&mute=0";
$currentLevel = "A2"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
    ...
    <div class="quiz-card">
        ...
        <p style="margin-bottom: 20px;">
            Mateo neden kahve dükkanında kendisini kötü hissetti?
        </p>

        <div class="options-group">
            <button class="option-btn" onclick="handleChoice(this, false)">
                A) Kahvesi çok soğuk geldiği için.
            </button>
            <button class="option-btn" onclick="handleChoice(this, true)">
                B) İnsanlar yavaş konuştuğu için ona güldüğü için.
            </button>
            <button class="option-btn" onclick="handleChoice(this, false)">
                C) Yanlış tatlıyı sipariş ettiği için.
            </button>
            <button class="option-btn" onclick="handleChoice(this, false)">
                D) Sarah randevuya geç kaldığı için.
            </button>
        </div>
        ...
        <div id="hint-box">
            ...
            <p style="font-size: 0.85rem; color: #cbd5e1;">
                Videonun 00:50 saniyelerinde Mateo'nun <b>"people laughed at me"</b> (insanlar bana güldü) dediği kısma odaklan.
            </p>
        </div>
    </div>
</section>
...
<footer class="action-footer">
    <a href="video_secme.php" class="btn-nav">A1 Testine Geç</a>
    <a href="video_seviye12.php" class="btn-nav">Sonraki ➡️</a>
</footer>
