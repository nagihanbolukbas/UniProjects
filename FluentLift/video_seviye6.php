...
$videoSource = "https://www.youtube.com/embed/hrGRog5BTjc?start=18&autoplay=1&mute=0";
$currentLevel = "A1"; 
?>
<!DOCTYPE html>
<html lang="tr">
   ...
   <section class="content-layout">
    ...
    <div class="quiz-card">
        ...
        <p style="font-size: 0.95rem; margin-bottom: 20px; line-height: 1.6;">
            Konuşmacı doğada en çok nereyi sevdiğini söylüyor?
        </p>
        ...
        <div id="hint-box">
            ...
            <p style="font-size: 0.85rem; color: #cbd5e1;">
                Videoda <b>mountains</b> kelimesine dikkat et.
            </p>
        </div>
    </div>
</section>
...
<footer class="action-footer">
    <a href="video_seviye5.php" class="btn-nav">⬅️ Önceki</a>
    <a href="video_seviye7.php" class="btn-nav">Sonraki ➡️</a>
</footer>
