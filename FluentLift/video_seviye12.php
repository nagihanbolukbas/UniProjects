...
// Videoyu Anna'nın terlik aramaya başladığı 04:30 dakikasına (270. saniye) yönlendirdim
$videoSource = "https://www.youtube.com/embed/svBiTnb6-QM?start=270&autoplay=1&mute=0";
$currentLevel = "A2"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
    ...
    <div class="quiz-card">
        ...
        <p style="font-size: 0.95rem; margin-bottom: 20px; line-height: 1.6;">
            Anna arkadaşı için hangi iki ürünü hediye olarak satın alıyor?
        </p>

        <div class="options-group">
            <button class="option-btn" onclick="handleChoice(this, false)">
                A) Sabahlık ve Terlik
            </button>
            <button class="option-btn" onclick="handleChoice(this, false)">
                B) Pijama ve Hediye Çantası
            </button>
            <button class="option-btn" onclick="handleChoice(this, true)">
                C)  Çorap ve Göz Maskesi
            </button>
            <button class="option-btn" onclick="handleChoice(this, false)">
                D) Bandana ve Çorap
            </button>
        ...
        <div id="hint-box">
            ...
            <p style="font-size: 0.85rem; color: #cbd5e1;">
                Görevli "The socks and eye mask together as a gift set" ifadesine dikkat et.
            </p>
        </div>
    </div>
</section>
...
<footer class="action-footer">
    <a href="video_seviye11.php" class="btn-nav">
        <span>⬅️</span> Önceki Video
    </a>
    <a href="video_seviye13.php" class="btn-nav">
