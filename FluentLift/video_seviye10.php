...
$videoSource = "https://www.youtube.com/embed/ppOYkGYvp6g?start=38&autoplay=1&mute=0";
$currentLevel = "A1"; 
?>
<!DOCTYPE html>
<html lang="tr">
...
<div class="quiz-card">
    ...
    <p style="font-size: 0.95rem; margin-bottom: 20px; line-height: 1.6;">
        Videoda "Saat 10" ifadesinden sonra hangi saat söyleniyor?
    </p>
    ...
    <div id="hint-box">
        ...
        <p style="font-size: 0.85rem; color: #cbd5e1;">
            Videoda saatler sırayla sayılıyor:
            <b>Saat bir, saat iki, saat üç...</b>
        </p>
    </div>
</div>
</section>
...
<footer class="action-footer">
    <a href="video_seviye9.php" class="btn-nav">⬅️ Önceki</a>
    <a href="video_secme2.php" class="btn-nav">A2 Testine Geç</a>
</footer>
