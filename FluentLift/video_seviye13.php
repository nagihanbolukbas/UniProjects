...
$videoSource = "https://www.youtube.com/embed/0bcliyEndTg?start=270&autoplay=1&mute=0";
$currentLevel = "A2";
?>
<!DOCTYPE html>
<html lang="tr">
...
<section class="content-layout">
    ...
    <div class="quiz-card">
        ...
        <p style="margin-bottom: 20px;">
            Konuşmacıya göre küçük bir hata yaptığınızda neden <b>özür dilememelisiniz</b>?
        </p>

        <div class="options-group">
            <button class="option-btn" onclick="handleChoice(this, false)">
                A) Seyirci hatalardan nefret ettiği için.
            </button>
            <button class="option-btn" onclick="handleChoice(this, true)">
                B) Hataya dikkat çekmemek ve odağı dağıtmamak için.
            </button>
            <button class="option-btn" onclick="handleChoice(this, false)">
                C) Zaman kaybetmemek için.
            </button>
            <button class="option-btn" onclick="handleChoice(this, false)">
                D) Kendinizi çok zeki göstermek için.
            </button>
        </div>

        <div id="hint-box">
            <h4 style="color: #ff6b6b; font-size: 0.9rem;">💡 İpucu</h4>
            <p style="font-size: 0.85rem; color: #cbd5e1;">
                Videoda Ramona, "If you apologize, you call attention to the mistake" (Özür dilerseniz, hataya dikkat çekersiniz) diyor.
            </p>
        </div>
    </div>
</section>
...
<footer class="action-footer">
    <a href="video_seviye12.php" class="btn-nav">
        <span>⬅️</span> Önceki Video
    </a>
    <a href="video_seviye14.php" class="btn-nav">
        Sonraki Video <span>➡️</span>
    </a>
</footer>
